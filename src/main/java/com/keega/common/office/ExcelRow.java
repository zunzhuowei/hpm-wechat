package com.keega.common.office;

import java.util.List;

import com.keega.common.utils.StrUtil;
...
public class ExcelRow {
    ...
    public boolean isEmptyRow() {
        ...
        for (ExcelCell excelCell : cells) {
            if (excelCell != null && excelCell.getValue() != null && StrUtil.isNotBlank(excelCell.getStringValue())) {
                return false;
            }
        }
        return true;
