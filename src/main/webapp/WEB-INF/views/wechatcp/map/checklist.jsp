...
<div>
    ...
    <div class="weui-actionsheet" id="iosActionsheet">
        <div class="weui-actionsheet__menu">
            <div class="weui-actionsheet__cell" id="morning">上午</div>
            <div class="weui-actionsheet__cell" id="afternoon">下午</div>
        </div>
...
<!-- end actionSheet -->
<!--BEGIN actionSheet 上午 -->
<div>
    <div class="weui-mask" id="iosMaskMo" style="display: none"></div>
    <div class="weui-actionsheet" id="iosActionsheetMo">
        <div class="weui-actionsheet__menu">
            上午
        ...
        <div class="weui-actionsheet__action">
            <div class="weui-actionsheet__cell" id="iosActionsheetCancelMo">返回</div>
        </div>
    </div>
</div>
<!-- end actionSheet -->
<!--BEGIN actionSheet 下午 -->
<div>
    <div class="weui-mask" id="iosMaskAf" style="display: none"></div>
    <div class="weui-actionsheet" id="iosActionsheetAf">
        <div class="weui-actionsheet__menu">
            下午
        ...
        <div class="weui-actionsheet__action">
            <div class="weui-actionsheet__cell" id="iosActionsheetCancelAf">返回</div>
        </div>
    </div>
</div>
<!-- end actionSheet -->
...
<script type="text/javascript">
    ...
    function init(userList) {
        ...
        for (var i=0;i<userList.length;i++) {
            ...
            lis = lis + "<li data-filtertext=\""+u.B0110+u.E0122+u.E01A1+u.A0101+"\"" +
                    ...
                    " class='ui-last-child'>" +
                            "<a id=\""+u.A0100+"\" class='ui-btn ui-btn-icon-right ui-icon-carat-r'>"+u.A0101+"</a>" +
                        "</li>";
        }
        $('#outPut').html(lis);
    ...
    var $iosMask = $('#iosMask');
    var $iosActionsheetMo = $('#iosActionsheetMo');
    var $iosMaskMo = $('#iosMaskMo');
    var $iosActionsheetAf = $('#iosActionsheetAf');
    var $iosMaskAf = $('#iosMaskAf');

    function hideActionSheet() {
        $iosActionsheet.removeClass('weui-actionsheet_toggle');
        $iosMask.fadeOut(200);
    }
    function hideActionSheetMo() {
        $iosActionsheetMo.removeClass('weui-actionsheet_toggle');
        $iosMaskMo.fadeOut(200);
        $iosActionsheet.addClass('weui-actionsheet_toggle');
        $iosMask.fadeIn(200);
    }
    function hideActionSheetAf() {
        $iosActionsheetAf.removeClass('weui-actionsheet_toggle');
        $iosMaskAf.fadeOut(200);
        $iosActionsheet.addClass('weui-actionsheet_toggle');
        $iosMask.fadeIn(200);
    }
    function hideActionSheet_Mo() {
        $iosActionsheetMo.removeClass('weui-actionsheet_toggle');
        $iosMaskMo.fadeOut(200);
        $iosActionsheet.removeClass('weui-actionsheet_toggle');
        $iosMask.fadeOut(200);
        $iosActionsheetAf.addClass('weui-actionsheet_toggle');
        $iosMaskAf.fadeIn(200);
    }
    function hideActionSheet_Af() {
        $iosActionsheetAf.removeClass('weui-actionsheet_toggle');
        $iosMaskAf.fadeOut(200);
        $iosActionsheet.removeClass('weui-actionsheet_toggle');
        $iosMask.fadeOut(200);
        $iosActionsheetMo.addClass('weui-actionsheet_toggle');
        $iosMaskMo.fadeIn(200);
    }

    $iosMask.on('click', hideActionSheet);
    $('#iosActionsheetCancel').on('click', hideActionSheet);

    $('#morning').on('click', hideActionSheet_Af);
    $('#afternoon').on('click', hideActionSheet_Mo);

    $iosMaskMo.on('click', hideActionSheetMo);
    $('#iosActionsheetCancelMo').on('click', hideActionSheetMo);
    $iosMaskAf.on('click', hideActionSheetAf);
    $('#iosActionsheetCancelAf').on('click', hideActionSheetAf);
